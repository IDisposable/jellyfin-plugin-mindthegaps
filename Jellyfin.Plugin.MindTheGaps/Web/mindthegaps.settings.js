...
function loadConfig(page, config) {
    ...
    page.querySelector('#ScanDiscogsWantlist').checked = config.ScanDiscogsWantlist;
    page.querySelector('#DiscogsUsername').value = config.DiscogsUsername || '';
    page.querySelector('#ScanOpenLibraryWantToRead').checked = config.ScanOpenLibraryWantToRead;
    page.querySelector('#OpenLibraryUsername').value = config.OpenLibraryUsername || '';
    page.querySelector('#ScanImdbLists').checked = config.ScanImdbLists;
    page.querySelector('#ImdbListIds').value = config.ImdbListIds || '';
    page.querySelector('#ScanImdbPeopleLists').checked = config.ScanImdbPeopleLists;
    page.querySelector('#ScanJustWatchLists').checked = config.ScanJustWatchLists;
    page.querySelector('#ScanJustWatchLikes').checked = config.ScanJustWatchLikes;
    ...
    page.querySelector('#TvdbPin').value = config.TvdbPin || '';
    page.querySelector('#ScanTvdbFavorites').checked = config.ScanTvdbFavorites;
...
function saveConfig(page, e) {
    ...
    ApiClient.getPluginConfiguration(pluginId).then(function (config) {
        ...
        config.ScanDiscogsWantlist = form.querySelector('#ScanDiscogsWantlist').checked;
        config.DiscogsUsername = form.querySelector('#DiscogsUsername').value.trim();
        config.ScanOpenLibraryWantToRead = form.querySelector('#ScanOpenLibraryWantToRead').checked;
        config.OpenLibraryUsername = form.querySelector('#OpenLibraryUsername').value.trim();
        config.ScanImdbLists = form.querySelector('#ScanImdbLists').checked;
        config.ImdbListIds = form.querySelector('#ImdbListIds').value.trim();
        config.ScanImdbPeopleLists = form.querySelector('#ScanImdbPeopleLists').checked;
        config.ScanJustWatchLists = form.querySelector('#ScanJustWatchLists').checked;
        config.ScanJustWatchLikes = form.querySelector('#ScanJustWatchLikes').checked;
        ...
        config.TvdbPin = form.querySelector('#TvdbPin').value.trim();
        config.ScanTvdbFavorites = form.querySelector('#ScanTvdbFavorites').checked;
