...
| **Scan TheTVDB favourites** (`ScanTvdbFavorites`) | Off | Surfaces the unowned series favourited on TheTVDB. Needs the **TheTVDB API key** and the **subscriber PIN** under Data sources. Expect few results: a favourite is usually a show you already hold. | The favourites are ignored. |
